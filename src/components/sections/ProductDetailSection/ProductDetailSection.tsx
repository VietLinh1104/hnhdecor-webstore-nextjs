...
export const ProductDetailSection = ({
  ...
  const originalPrice = selectedVariant?.calculated_price?.original_amount || 0;
    ...
    <section className="max-w-screen-2xl w-full mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          {originalPrice > finalPrice && (
            <>
              <span className="line-through text-gray-500">{formatVND(originalPrice)}</span>
        ...
        <div className="text-sm text-gray-500">
          ...
          <span className="text-red-600 font-medium">
            {formatVND(originalPrice - finalPrice)}
          </span>)
        </div>
